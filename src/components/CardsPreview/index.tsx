...
const OneSVGWithTwoFrames = ({
    ...
    qrCodeSvg = "<svg><!-- Insert QR code here --></svg>",
    ...
    return (
        <div className="p-0">
            <svg
                ref={svgRef}
                // Total width = 2 frames wide = (2 * 5.4cm) = 10.8                                                                                                                                                                                                                                                                                                                                                                                 cm
                // Height = 8.56cm
                width="10.80cm"
                height="8.56cm"
                ...
                <g id="frame2" transform="translate(540, 0)">
                    ...
                    >
                        <rect
                            ...
                            width="49"
                            height="12"
                            fill="#2E2E2E"  // or any color you like
                        />
                    ...
                    {/* Insert QR code as raw SVG in the middle */}
                    <g
                        transform="translate(270,400) scale(0.4)"
